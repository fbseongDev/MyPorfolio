...
class Code extends m.StatelessWidget {
  ...
  m.Widget _codeHeaderBuilder() => m.Builder(builder: (context){
    return m.Padding(
                  ...
                  return m.Tooltip(
                    ...
                    child: m.InkWell(
                        ...
                        onTap: () async {
                          ...
                          Clipboard.setData(ClipboardData(text: codePlane.planeText));
  ...
  m.Widget _codeDividerBuilder() => m.Builder(builder: (context){
    return m.Container(
  ...
  m.Widget _codeFieldBuilder() => m.Builder(builder: (context){
    return m.Container(
      padding: m.EdgeInsets.all(16),
      child: m.SelectableText.rich(
        m.TextSpan(
